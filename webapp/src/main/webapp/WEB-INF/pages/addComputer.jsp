...
<section id="main">
	...
	<div class="panel panel-default col-md-4 col-md-offset-4">
		<div class="panel-body">
			<form:form id="frm" commandName="computerDto" action="addcomputer"
				method="POST">
				...
				or <a class="btn btn-success" id="cancel" href="dashboard"><spring:message
						code="label.cancel" /></a>
			</form:form>
		</div>
	</div>
